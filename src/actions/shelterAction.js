...
export const fetchShelter = shelterID => dispatch => {
    ...
    return axios
    //.get(`https://staging2-pawsnfind.herokuapp.com/api/shelters/${shelterID}`)
    .get(`https://staging2-pawsnfind.herokuapp.com/api/shelters/${shelterID}`)
    .then(res => {
...
export const fetchOptions = (shelterID) => dispatch => {
    ...
    return axios
    .get(`https://staging2-pawsnfind.herokuapp.com/api/internal/paws/options/${shelterID}`)
    .then(res => {
...
export const addShelterLoc = (shelterID, location) => dispatch => {
    ...
    return axios
    .post(`https://staging2-pawsnfind.herokuapp.com/api/shelters/${shelterID}/location`, location)
    .then(res => {
...
export const updateShelterLoc = (locationId, updatedChange) => dispatch => {
    ...
    return axios
    .put(`https://staging2-pawsnfind.herokuapp.com/api/shelters/location/${locationId}`, updatedChange)
    .then(res => {
...
export const deleteShelterLoc = locationId => dispatch => {
    ...
    return axios
    .delete(`https://staging2-pawsnfind.herokuapp.com/api/shelters/location/${locationId}`, locationId)
    .then(res => {
...
export const addShelterCon = (shelterID, contact) => dispatch => {
    ...
    return axios
    .post(`https://staging2-pawsnfind.herokuapp.com/api/shelters/${shelterID}/contact`, contact)
    .then(res => {
...
export const updateShelterCon = (contactId, change) => dispatch => {
    ...
    return axios
    .put(`https://staging2-pawsnfind.herokuapp.com/api/shelters/contact/${contactId}`, change)
    .then(res => {
...
export const deleteShelterCon = contactId => dispatch => {
    ...
    return axios
    .delete(`https://staging2-pawsnfind.herokuapp.com/api/shelters/contact/${contactId}`, contactId)
    .then(res => {
