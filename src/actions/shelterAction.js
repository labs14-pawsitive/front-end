...
export const addShelterLoc = (shelterID, location) => dispatch => {
    ...
    return axios
    .post(`https://staging1-pawsnfind.herokuapp.com/api/shelters/${shelterID}/location`, location)
    .then(res => {
...
export const deleteShelterLoc = locationId => dispatch => {
    ...
    return axios
    .delete(`https://staging1-pawsnfind.herokuapp.com/api/shelters/location/${locationId}`, locationId)
    .then(res => {
...
export const addShelterCon = (shelterID, contact) => dispatch => {
    ...
    return axios
    .post(`https://staging1-pawsnfind.herokuapp.com/api/shelters/${shelterID}/contact`, contact)
    .then(res => {
...
export const deleteShelterCon = contactId => dispatch => {
    ...
    return axios
    .delete(`https://staging1-pawsnfind.herokuapp.com/api/shelters/contact/${contactId}`, contactId)
    .then(res => {
