...
export const addShelterLoc = (shelterID, location) => dispatch => {
    ...
    return axios
    .post(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/${shelterID}/location`, location)
    .then(res => {
...
export const updateShelterLoc = (locationId, updatedChange) => dispatch => {
    ...
    return axios
    .put(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/location/${locationId}`, updatedChange)
    .then(res => {
...
export const deleteShelterLoc = locationId => dispatch => {
    ...
    return axios
    .delete(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/location/${locationId}`, locationId)
    .then(res => {
...
export const addShelterCon = (shelterID, contact) => dispatch => {
    ...
    return axios
    .post(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/${shelterID}/contact`, contact)
    .then(res => {
...
export const updateShelterCon = (contactId, change) => dispatch => {
    ...
    return axios
    .put(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/contact/${contactId}`, change)
    .then(res => {
...
export const deleteShelterCon = contactId => dispatch => {
    ...
    return axios
    .delete(`${process.env.REACT_APP_BACKEND_URL}/api/shelters/contact/${contactId}`, contactId)
    .then(res => {
