...
export const updateApplication = ( updatedStatus, id ) => dispatch => {
    ...
    return axios
    .put(`http://localhost:8000/api/applications/${id}/status`, updatedStatus )
    .then(res => {
...
export const addNotes = ( newNote, id ) => dispatch => {
    ...
    return axios
        .post(`http://localhost:8000/api/applications/${id}/note`, newNote )
        .then(res => {
            console.log(res);
...
export const getNotes = id => dispatch => {
    ...
    return axios
        .get(`http://localhost:8000/api/applications/${id}/notes`)
        .then(res => {
            console.log(res)
...
export const deleteNotes = id => dispatch => {
    ...
    return axios
    .delete(`http://localhost:8000/api/applications/note/${id}`)
    .then(res => {
...
export const updateNotes = ( updatedNote, id ) => dispatch => {
    ...
    return axios 
    .put(`http://localhost:8000/api/applications/note/${id}`, updatedNote )
    .then(res => {
        console.log(res)
...
export const fetchOptions = id => dispatch => {
    ...
    return axios
    .get(`http://localhost:8000/api/internal/paws/options/${id}`)
    .then(res => {
        console.log(res)
